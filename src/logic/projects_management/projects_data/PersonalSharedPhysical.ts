...
export namespace PersonalSharedPhysical
{
    export function getProject(imagePrePath: string): Project
    {
        return new Project(
            ...
            <ProjectSources>{
                thumbnail: imagePrePath + 'Personal.jpg',
                footage: [
                    imagePrePath + 'Physical_chop.jpg',
                    imagePrePath + 'Personal_smalltree.jpg',
                    imagePrePath + 'Shared.jpg',
                    imagePrePath + 'Physical_3d.jpg',
                    imagePrePath + 'Physical_dat.jpg',
