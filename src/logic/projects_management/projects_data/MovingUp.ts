...
export namespace MovingUp
{
    export function getProject(imagePrePath: string): Project
    {
        return new Project(
            ...
            <ProjectSources>{
                thumbnail: imagePrePath + 'endless_mode.jpg',
                footage: [
                    imagePrePath + 'level_select.jpg',
                    imagePrePath + 'endless_mode.jpg',
                    imagePrePath + 'level12.jpg',
                    imagePrePath + 'startscreen.jpg',
                    imagePrePath + 'level16.jpg',
                    imagePrePath + 'pausemenu.jpg',
