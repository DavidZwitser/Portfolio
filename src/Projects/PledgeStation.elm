...
data =
    ...
    , text =
        ...
        , longDescription = "I had the pleasure of working together with Tellart, where I got to help out with two pavillions. One was the Dutch pavillion where I got to develop the visual/ interactive part of an infinity mirror installation designed to leave the visitors with optimism and inpsiration. The other was the introduction projection show for the Phillipines where I got to develop tools and setup a system for that show. A product of that was a nice timeline editor, render and playout tool in TouchDesigner originally also designed to distribute real time render power between two pc's."
        , processDescription = "When I got the join the team, the idea of an infinity mirror was set, and I got to (working together with audio and hardware partners) design the visual / interactin system."
    ...
    , sources =
        ...
        , finalFootage =
            ...
            , Project.YoutubeEmbedded { fileName = "0MrpMJxeoPc?si=BPl77dfzQk8nu6O3", description = "a video showing a bit of the creative process" }
            ...
            , Project.Video { fileName = "editor_system.mov", description = "This is a torn down example of what the editor system looked like." }
            ]
        , processFootage = []
