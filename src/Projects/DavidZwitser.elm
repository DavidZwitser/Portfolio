...
data =
    ...
    , text =
        ...
        , longDescription = "Hello, I am David. I am a young starting artist with my roots in programming. My mainly focus on interactive installations but venture out to all types of ways of making."
