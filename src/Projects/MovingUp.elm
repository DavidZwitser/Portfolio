...
data =
    ...
    , text =
        ...
        --
        , description = "A physics based skill game where you balance a ball on a bar and try to get to the end of puzzle like levels or where you reach a new highscore in endless mode."
