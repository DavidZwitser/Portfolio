import Project, { ProjectSources } from "../../logic/projects_management/ProjectTemplate";
...
/* List viewer class */
export default class CircleViewer extends React.Component<CircleViewerProps, CircleViewerStates>
{
