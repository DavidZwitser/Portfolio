    ...
    export function getProject(): Project {
        return new Project(
            <ProjectText>{
                ...
                goal: 'The goal was to make a website which presented the students who participated in the seminar and their final works. The website was to be hosted and accessible for everyone to view.',
            ...
            <ProjectSources>{
                thumbnail: 'footage/projects/ExpositionWebsite/front-page.jpg',
                footage: [
                    'footage/projects/ExpositionWebsite/project-open.jpg',
                    'footage/projects/ExpositionWebsite/other-image.jpg',
                    'footage/projects/ExpositionWebsite/maker-overview.jpg',
                    'footage/projects/ExpositionWebsite/front-page.jpg',
                ],
