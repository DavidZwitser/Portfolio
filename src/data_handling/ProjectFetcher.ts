...
import { CanWorld } from "../projects_management/projects_data/CanWorld";
import { CanvasArtistImpression } from "../projects_management/projects_data/CanvasArtistImpression";
...
export default class ProjectFetcher {
    ...
    private loadBigProjects() {
        this.projects.push(
            ...
            CanvasArtistImpression.getProject(),
